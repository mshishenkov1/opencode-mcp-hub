...
негативный прогон теперь имеют все **семь** наборов перечня п. 7 (§34.3), а текст AC-252 приведён к
факту: одиннадцать карточек и десять записей следа. Новых заданий test-агенту ревизия не порождает.
